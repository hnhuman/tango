...
YG.Bottom = {
    ...
    Comm: {
        ...
        serverTimeProcess: function() {
            ...
            if (f.length > 0) {
                ...
                GetJPData(apiUrl, "servertime", "time=" + c, function(h) {
                    if (h.code == 0) {
                        a = h.num
                    }
                    var g = function() {
        ...
        getUserTotalBuyCount: function() {
            ...
            var b = false;
            var a = function() {
                GetJPData(apiUrl, "totalBuyCount", "", function(o) {
                    if (o.state == 0) {
                        f.html("￥" + o.fundTotal);
                        var k = o.count;
                        if (d != k) {
        ...
        disablePassword: function() {
            $('input[type="password"]').bind("cut copy paste", function(a) {
                a.preventDefault()
            })
        }
    },
        ...
        loginInfoProcess: function() {
            ...
            _GetUserLoginInfo = function() {
                if (c.TopRightBox.length > 0) {
                    GetJPData(apiUrl, "logininfo", "", function(e) {
            ...
            if (c.liMsgObj && c.liMsgObj.length > 0) {
                ...
                if (b != "-1") {
                    if (b == "1") {
                        ...
                        ;
                        var d = function() {
                            GetJPData(apiUrl, "ckmsg", "", function(e) {
                                if (e.code == 0) {
                                    $.cookie("_msgTip", null , {
                                        domain: "1yyg.com"
                                    });
    ...
    RightTool: {
            ...
            if (d.RightToolObj.length > 0 || d.miniRightToolObj.length > 0) {
                ...
                var a = function() {
                    if (d.isMiniTool) {
                        ...
                        d.backTopObj.on("click", function() {
                            $("body, html").animate({
                                scrollTop: 0
                            }, 100);
                            return false
        ...
        submitMiniLogin: function() {
            ...
            GetJPData("https://passport.1yyg.com", "userlogin", f, function(h) {
                var i = h.state;
                if (i != 0) {
        ...
        switchMiniLogin: function() {
            ...
            a.on("click", ".z-clump-icon.wx-login", function() {
                b.hide();
                d.show()
            });
            a.on("click", ".wxLogin-con a", function() {
                b.show();
                d.hide()
            });
            ...
            a.on("click", ".delete-close", function() {
            ...
            $("#btnWXLogin").click(function() {
                ...
                if (_IsIE && _IeVersion == 6) {
                    ...
                    if (c.isWxLoginJsLoaded) {
                        ...
                        Base.getScript("https://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js", function() {
                            e();
        ...
        getVcCode: function() {
            ...
            b.$vcCanvas.hide();
            GetJPData("https://passport.1yyg.com", "getVcChar", "key=" + c, function(d) {
                if (d.state == 1) {
                    b.resetVcCode();
        ...
        vcCodeEvtReg: function() {
            ...
            d.click(function(m) {
                ...
                var k = m.pageX - l;
                var n = m.pageY - o;
                GetJPData("https://passport.1yyg.com", "VcCompare", "x=" + k + "&y=" + n, function(p) {
                    if (p.state == 1) {
                        if (p.num == 1) {
        ...
        rightToolEvent: function() {
            ...
            var h = false;
            var c = false;
            e.RightCartObj.on("mouseenter", function() {
                if (d != null ) {
                    clearTimeout(d)
                }
                if (a != null ) {
...
$(function() {
    Base.getScript(skinUrl + "/JS/Comm.js?date=16071500", function() {
