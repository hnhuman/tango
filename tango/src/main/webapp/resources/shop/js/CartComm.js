...
var $CartComm = function() {
    ...
    ;
    var i = function(s, r) {
        GetJPData(cartDomain, "getBarcodeInfoByID", "codeID=" + s, function(t) {
            if (t.code == 0) {
                var u = t.listItems;
                if (u.length > 0) {
                    r(u[0])
    ...
    var o = function(x) {
        ...
        if (r != null ) {
            ...
            if (w != "" && t != "") {
                ...
                $cartFun.setSelValue(w, t, function() {
    ...
    ;
    var b = function(r, s) {
        GetJPData(cartDomain, "getGoodsSalingByGoodsID", "goodsID=" + r, function(t) {
            if (t.code == 0) {
                s(t.NewCodeInfo)
            } else {
                s(null )
