package com.tango.core.mybatis;
...
import com.tango.core.mybatis.handler.ColumnHandler;
import com.tango.core.mybatis.handler.ConditionHandler;
import com.tango.core.mybatis.handler.DeleteByConditionHandler;
import com.tango.core.mybatis.handler.DeleteByIdsHandler;
import com.tango.core.mybatis.handler.DeleteHandler;
import com.tango.core.mybatis.handler.InsertHandler;
import com.tango.core.mybatis.handler.ResultMapHandler;
import com.tango.core.mybatis.handler.SelectAllHandler;
import com.tango.core.mybatis.handler.SelectByConditionHandler;
import com.tango.core.mybatis.handler.SelectByEntityHandler;
import com.tango.core.mybatis.handler.SelectByIdsHandler;
import com.tango.core.mybatis.handler.SelectByPageHandler;
import com.tango.core.mybatis.handler.SelectHandler;
import com.tango.core.mybatis.handler.UpdateByConditionHandler;
import com.tango.core.mybatis.handler.UpdateHandler;
...
public class MySqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
		...
		if (!isEmpty(this.mapperLocations)) {
			for (Resource mapperLocation : this.mapperLocations) {
				...
				try {
					...
					if (!Strings.isNullOrEmpty(baseXMLString)) {
	...
	private String getBaseXMLString(InputStream inputStream) {
		...
		try {
			...
			if (!Strings.isNullOrEmpty(entityFullName)) {
